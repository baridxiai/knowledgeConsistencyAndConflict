        ...
        with torch.no_grad():
            for i in tqdm(range(0, batch_cnt)):
                ...
                if len(selected_layers) == 0 or -1 in selected_layers:
                    ...
                    mono_outputs = self.model.forward(input_ids = mono_inputs["input_ids"], attention_mask=mono_inputs["attention_mask"])
                    ...
                    cs_outputs = self.model.forward(input_ids = cs_inputs["input_ids"], attention_mask=cs_inputs["attention_mask"],ffn_intervention_position=-1, ffn_intervention=ffn_intervention,tgt_layer=intervened_ffn_layers)
