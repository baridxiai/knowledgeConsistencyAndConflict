        ...
        with torch.no_grad():
            for i in tqdm(range(0, batch_cnt)):
                ...
                if len(selected_layers) == 0 or -1 in selected_layers:
                    ...
                    ffn_intervention = [ self.model.model.model.layers[i].ffn_states[:,-1:,:] for i in range(len(self.model.model.model.layers))]
                    mono_hidden_states = [ self.model.model.model.layers[i].output for i in range(len(self.model.model.model.layers))]
                    ...
                    cs_hidden_states = [ self.model.model.model.layers[i].output for i in range(len(self.model.model.model.layers))]
