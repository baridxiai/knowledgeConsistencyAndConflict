...
class BertIntermediate(nn.Module):
    ...
    def forward(self, hidden_states, tgt_pos=None, tmp_score=None):
        hidden_states = self.dense(hidden_states)
...
class BertEncoder(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, tgt_layer=None, tgt_pos=None, tmp_score=None):
        all_encoder_layers = []
        ffn_weights = None
        for layer_index, layer_module in enumerate(self.layer):
                if tgt_layer == layer_index:
                    ...
                    hidden_states, _ = layer_module(hidden_states, attention_mask, tgt_pos=tgt_pos)
...
class BertModel(PreTrainedBertModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, tgt_pos=None, tgt_layer=None, tmp_score=None):
...
class BertForMaskedLM(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, tgt_pos=None, tgt_layer=None, tmp_score=None, tgt_label=None):
        if tmp_score is not None:
        ...
        last_hidden, ffn_weights = self.bert(input_ids=input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids, tgt_pos=tgt_pos, tgt_layer=tgt_layer, tmp_score=tmp_score)  # (batch, max_len, hidden_size), (batch, max_len, ffn_size)
